...
<?php require_once("../MainHead/head.php");?>
    <title>Renzo Anicama </>::Nuevo Ticket</title>
</head>
...
<div class="box-typical box-typical-padding">
    <p>
        Desde esta ventana podras generar nuevos Tickets de HelpDesk:        
    </p>
    ...
    <div class="row">
                    ...
                    <input type="hidden" id="usu_id" name="usu_id" value="<?php echo $_SESSION["usu_id"] ?>">
                        ...
                        <fieldset class="form-group">
                            ...
                            <select id="cat_id" name="cat_id" class="form-control select2" data-placeholder="Seleccionar">
                            </select>
                        </fieldset>
                        </div>
