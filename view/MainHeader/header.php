64<header class="site-header">
    <div class="container-fluid">
        ...
        <a href="#" class="site-logo">
            <img class="hidden-md-down" src="../../public/img/logodakota.png" alt="">
            <img class="hidden-lg-up" src="../../public/img/logodakota.png" alt="">
        </a>
            ...
            <div class="site-header-content-in">
                <div class="site-header-shown">
                    <div class="dropdown user-menu">
                        ...
                        <img src="../../public/js/<?php echo $_SESSION["rol_id"] ?>.jpg" alt="">
                            </button>
